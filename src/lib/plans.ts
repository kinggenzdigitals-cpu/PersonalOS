...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    features: [
      ...
      "Monthly budgets, bills, and reminders",
      "Today dashboard + month calendar",
      "Basic reports + full JSON data download",
  ...
  pro: {
    ...
    features: [
      ...
      "More accounts, goals, budgets, and habits",
      "Week + Agenda calendar",
      "1-year reports, charts, net worth",
      "CSV export · 3 custom themes",
    ],
    cta: "Start Pro",
    highlighted: true,
  },
  premium: {
    ...
    features: [
      ...
      "Higher accounts, goals, budgets, and habit limits",
      "5-year reports + financial forecasting",
      "CSV export · 10 custom themes",
